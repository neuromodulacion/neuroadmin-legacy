...
$row = mysql_fetch_array($result_emp1);
	...
	$ruta = $row["ruta"];
		$p1 = $row["p1"]; //¿El local está abierto?
			$images1= fotos($p1);  
			$dir_file_fotos1="http://aseguramientocalidad.dish.intra/prueba/fotos_aseg/".$ano."/".$mes."/representantes/".$empresa."/id_".$xid."/local_abierto.jpg"; 
			//$dir_file_fotos1= dir_fotos($dir_fotos_name1);   		
		$p2 = $row["p2"]; //¿Cuentan con tv o pantalla con la programación de Dish?
			$images2= fotos($p2);  
			$dir_file_fotos2="http://aseguramientocalidad.dish.intra/prueba/fotos_aseg/".$ano."/".$mes."/representantes/".$empresa."/id_".$xid."/pantalla_tv.jpg"; 
			//$dir_file_fotos2= dir_fotos($dir_fotos_name2);  		
		$p3 = $row["p3"]; //¿Tienen instalado el equipo Dish con All Access?
			$images3= fotos($p3);  
			$dir_file_fotos3="http://aseguramientocalidad.dish.intra/prueba/fotos_aseg/".$ano."/".$mes."/representantes/".$empresa."/id_".$xid."/all_access.jpg"; 
			//$dir_file_fotos3= dir_fotos($dir_fotos_name3);  		
