       	...
       	<?php        	
			...
			SELECT 
			    ...
			    (SELECT COALESCE(SUM(pagos.importe), 0) 
			     ...
			     WHERE MONTH(pagos.f_captura) = $mes_ahora 
			     AND YEAR(pagos.f_captura) = $anio 
			     AND pagos.negocio = 'Neuromodulacion GDL') AS diferencia";
        	...
        	<?php        	
				...
				FROM (
				    ...
				    FROM 
				        (SELECT tms_d FROM historico_sesion WHERE tms_d >= 21140429 and tms_d <= 24054977  ORDER BY tms_d DESC) AS ordered_sessions,
			...
			SELECT 
			    (SELECT COALESCE(SUM(cobros.importe), 0) 
			     ...
			     WHERE MONTH(cobros.f_captura) = $mes_ahora 
			     AND YEAR(cobros.f_captura) = $anio 
			     AND cobros.doctor = 'Dr. Alejandro Aldana') AS cobros,
					 
			    (SELECT COALESCE(SUM(pagos.importe), 0) 
			     FROM pagos 
			     WHERE MONTH(pagos.f_captura) = $mes_ahora 
			     AND YEAR(pagos.f_captura) = $anio 
			     AND pagos.negocio = 'Dr. Alejandro Aldana') AS pagos,
			    ...
			    (SELECT COALESCE(SUM(pagos.importe), 0) 
			     ...
			     WHERE MONTH(pagos.f_captura) = $mes_ahora 
			     AND YEAR(pagos.f_captura) = $anio 
			     AND pagos.negocio = 'Dr. Alejandro Aldana') AS diferencia";
			...
			SELECT 
			    (SELECT COALESCE(SUM(cobros.importe), 0) 
			     ...
			     WHERE MONTH(cobros.f_captura) = $mes_ahora 
			     AND YEAR(cobros.f_captura) = $anio 
			     AND cobros.doctor = 'Dra. Eleonora Ocampo') AS cobros,
					 
			    (SELECT COALESCE(SUM(pagos.importe), 0) 
			     FROM pagos 
			     WHERE MONTH(pagos.f_captura) = $mes_ahora 
			     AND YEAR(pagos.f_captura) = $anio 
			     AND pagos.negocio = 'Dra. Eleonora Ocampo') AS pagos,
			    ...
			    (SELECT COALESCE(SUM(pagos.importe), 0) 
			     ...
			     WHERE MONTH(pagos.f_captura) = $mes_ahora 
			     AND YEAR(pagos.f_captura) = $anio 
			     AND pagos.negocio = 'Dra. Eleonora Ocampo') AS diferencia";
