...
<!-- Incluye estilos CSS para los diferentes plugins usados en la página -->
<!-- Estilo para JQuery DataTable -->
<link href="<?php echo $ruta; ?>plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css" rel="stylesheet">
<!-- Estilo para Bootstrap Material Datetime Picker -->
<link href="<?php echo $ruta; ?>plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css" rel="stylesheet" />
<!-- Estilo para Bootstrap DatePicker -->
<link href="<?php echo $ruta; ?>plugins/bootstrap-datepicker/css/bootstrap-datepicker.css" rel="stylesheet" />
<!-- Estilo para Wait Me -->
<link href="<?php echo $ruta; ?>plugins/waitme/waitMe.css" rel="stylesheet" />
<!-- Estilo para Bootstrap Select -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div style="height: 95%"  class="header">
                        ...
                        <!-- Botón para abrir un modal (inicialmente oculto) -->
                            ...
                            <form id="wizard_with_validation" method="POST" action="guarda_cobro.php" >
                                ...
                                <fieldset>
                                    <div class="demo-radio-button">
                                        <!-- Campos ocultos que se llenarán según la selección del tipo de cobro -->
                                        ...
                                        <!-- Radio button para seleccionar "Consulta Medica" -->
                                        ...
                                        <script type='text/javascript'>
                                            $('#radio_1').change(function(){
                                                // Al seleccionar "Consulta Medica", muestra/oculta campos y habilita/deshabilita controles según sea necesario
                                                $('#val_tipo').val('ok');
                                                $('#medico').show();
                                                $('#terapia').hide();
                                                $('#paciente').show();
                                        ...
                                        <!-- Radio button para seleccionar "Terapia" -->
                                        ...
                                        <script type='text/javascript'>
                                            $('#radio_2').change(function(){
                                                // Al seleccionar "Terapia", muestra/oculta campos y habilita/deshabilita controles según sea necesario
                                                $('#val_tipo').val('ok');
                                                $('#medico').hide();
                                                $('#terapia').show();
                                                $('#paciente').show();
                                        ...
                                        <!-- Radio button para seleccionar "Renta Consultorio" -->
                                        ...
                                        <script type='text/javascript'>
                                            $('#radio_3').change(function(){
                                                // Al seleccionar "Renta Consultorio", muestra/oculta campos y habilita/deshabilita controles según sea necesario
                                                $('#val_tipo').val('ok');
                                                $('#medico').hide();
                                                $('#terapia').hide();
                                                $('#paciente').hide();
                                        ...
                                        <!-- Radio button para seleccionar "Otros" -->
                                        ...
                                        <script type='text/javascript'>
                                            $('#radio_4').change(function(){
                                                // Al seleccionar "Otros", muestra/oculta campos y habilita/deshabilita controles según sea necesario
                                                $('#val_tipo').val('ok');
                                                $('#medico').hide();
                                                $('#terapia').hide();
                                                $('#paciente').hide();
                                    ...
                                    <!-- Sección para seleccionar el médico -->
                                    <div id="medico" style="display: none" class="form-group form-float">
                                        ...
                                        <!-- Radio buttons para seleccionar el tipo de consulta -->
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                // Escuchar cambios en cualquier input radio con nombre "consultax"
                                                $('input[type="radio"][name="consultax"]').change(function() {
                                                    // Establecer el valor del input hidden con el valor del radio seleccionado
                                                    $('#consulta').val(this.value);
                                                    $('#consultaxx').val(this.value);
                                                });
                                                // Manejar el input en el campo "otros"
                                                $('#otros').on('input', function() {
                                                    // Actualizar el valor del input hidden con el valor actual del campo "otros"
                                    ...
                                    <!-- Sección para seleccionar el paquete de terapia -->
                                    <div id="terapia"  style="display: none"  class="form-group form-float">
                                        ...
                                        <select class='form-control show-tick'  id="costos_id" name="costos_id" required>
                                            ...
                                            <?php
                                                // Consulta para obtener la lista de paquetes de terapia
                                                $sql_costo = "
                                                SELECT
                                    ...
                                    <div id="paciente"  style="display: none" class="form-group form-float">
                                        ...
                                        <!-- Campos para buscar un paciente por nombre, apellidos, teléfono o email -->
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <script>
                                                    // Al hacer clic en el botón de buscar paciente, se envían los datos al servidor y se muestra el resultado en un modal
                                                    $('#buscar_paciente').click(function() {
                                                        ...
                                                        var datastring = 'paciente=' + paciente + '&tipo_c=' + tipo_c + '&apaterno=' + apaterno + '&amaterno=' + amaterno + '&celular=' + celular + '&email=' + email;
                                                        $.ajax({
                                                ...
                                                <!-- Botón para limpiar el formulario de búsqueda del paciente -->
                                                ...
                                                <script>
                                                    // Al hacer clic en el botón de limpiar, se vacían todos los campos de búsqueda del paciente
                                        ...
                                        <!-- Modal para mostrar los resultados de búsqueda de pacientes -->
                                    ...
                                    <!-- Campo oculto para almacenar la consulta -->
                                    ...
                                    <!-- Sección para seleccionar "Otros" -->
                                    <div id="otro" style="display: none" class="form-group form-float">
                                        ...
                                        <select name="otros_id" class='form-control show-tick' id="otros_id"  >
                                            ...
                                            <?php
                                                // Consulta para obtener la lista de opciones "Otros"
                                                $sql_paciente = "
                                                    SELECT
                                                        otros_menu.otros_id, 
                                                        otros_menu.otros
                                        ...
                                        <script>
                                            // Al seleccionar una opción en el campo "Otros", se asigna su valor al campo oculto correspondiente
                                    ...
                                    <!-- Campos para ingresar cantidad e importe -->
                                    <div class="row clearfix">
                                    ...
                                    <!-- Script para asegurar que el campo "importe" solo acepte números -->
                                    <script>
                                        document.getElementById('importe').addEventListener('input', function (e) {
                                            this.value = this.value.replace(/[^0-9]/g, ''); // Reemplaza cualquier caracter no numérico globalmente
                                        });
                                    </script>    

                                    <!-- Sección para seleccionar si se desea factura -->
                                    <div class="demo-radio-button">
                                        ...
                                        <!-- Radio buttons para seleccionar "Si" o "No" -->
                                    ...
                                    <!-- Botón para abrir un modal adicional si se requiere -->
                                    ...
                                    <!-- Modal para validar los datos del paciente -->
                                                    ...
                                                    <form>
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                <!-- Botón para buscar el RFC -->
                                                                <button id="buscar_rfc" type="button" style="background: #0096AA; color: white" class="btn btn-lg m-l-15 waves-effect">
                                                                    BUSCAR
                                                                </button>
                                                                <script>
                                                                    // Al hacer clic en "Buscar", se envían los datos al servidor y se muestran los resultados en el modal
                                    ...
                                    <!-- Sección para seleccionar la forma de pago -->
                                    ...
                                    <div class="demo-radio-button">	
                                        ...
                                        <label for="radiox_1">Tarjeta Credito</label>
                                        <script type='text/javascript'>
                                        ...
                                        <label for="radiox_2">Tarjeta Debito</label>
                                        <script type='text/javascript'>
                                    ...
                                    <div class="row clearfix demo-button-sizes">
                                        ...
                                        <script type='text/javascript'>
                                            // Al enviar el formulario, oculta el botón de guardar para evitar envíos duplicados
...
<?php if ($a == 1) { ?>	
    <!-- Script para abrir el modal si la variable $a es igual a 1 -->
    <script>
        $(document).ready(function() {
            $('#modal').click();
        });    	
...
<!-- Incluye los scripts JS para los diferentes plugins usados en la página -->
<!-- Moment Plugin Js -->
                	...
                	<fieldset>
                        ...
                        <div  id="medico" style="display: none" class="form-group form-float">
                            ...
                            <label for="consulta">Tipo consulta</label>
								...
								<script>
									$(document).ready(function() {
										// Escuchar cambios en cualquier input radio con nombre "consulta"
										$('input[type="radio"][name="consultax"]').change(function() {
											// Establecer el valor del input hidden con el valor del radio seleccionado
											$('#consulta').val(this.value);
											$('#consultaxx').val(this.value);
                        ...
                        <div id="terapia"  style="display: none"  class="form-group form-float">
                            ...
                            <select class='form-control show-tick'  id="costos_id" name="costos_id" required>
								...
								<?php
									...
									echo $sql_costo;
									$result_costo = ejecutar($sql_costo);  
									$cnt_costo = mysqli_num_rows($result_costo);
									while($row_costo = mysqli_fetch_array($result_costo)){
						            	extract($row_costo); 
						            	//print_r($row_costo); ?>
								<option value="<?php echo $costos_id; ?>|<?php echo $producto; ?>|<?php echo $costos; ?>|<?php echo $sesiones; ?>" ><?php echo $producto." - $ ".number_format($costos); ?></option>				
								<?php } ?>
								<!-- <option value="8|Paquete 30 sesiones Estimulación Magnética Transcraneal|30000|30" >Paquete 30 sesiones Estimulación Magnética Transcraneal - $ 30,000</option>
								<option value="9|Paquete 30 sesiones Estimulación Magnética Transcraneal|24000|30" >Paquete 30 sesiones Estimulación Magnética Transcraneal - $ 24,000</option>
								<option value="10|Una sesión Estimulación Magnética Transcraneal|1000|1" >Una sesión Estimulación Magnética Transcraneal - $ 1,000</option>
								<option value="11|Paquete 15 sesiones Estimulación transcraneal por corriente directa|9750|15" >Paquete 15 sesiones Estimulación transcraneal por corriente directa - $ 9,750</option>
								<option value="12|Paquete 15 sesiones Estimulación transcraneal por corriente directa|7500|15" >Paquete 15 sesiones Estimulación transcraneal por corriente directa - $ 7,500</option>
								<option value="13|Una sesión Estimulación transcraneal por corriente directa|650|1" >Una sesión Estimulación transcraneal por corriente directa - $ 650</option>
								<option value="14|Otros|0|1" >Otros - $ 0</option> -->								
                            </select>  
							<script>
							$(document).ready(function() {
							    $('#costos_id').change(function() {
							        ...
							        // Dividir el valor por el delimitador para obtener los valores individuales
							        var valores = valoresConcatenados.split('|');
							        
							        // Asignar los valores a variables (ajusta según la cantidad de valores esperados)
							        var costos_id = valores[0];
							        var producto = valores[1];
							        var costos = valores[2];
							        var sesiones = valores[3]; 
