...
echo "<hr> CurrencyID: ".$CurrencyID.
    ...
    "<br>email: ".$email.
    "<br>f_pago: ".$f_pago.
    "<br>PaymentTerm: ".$PaymentTerm.
    "<br>ticket: ".$ticket."<hr>";

// Configurar cantidad de venta
$Qty = 1; 					 
// Guardar la venta y obtener el ID de la remisión
$InvoiceID = guarda_venta($CurrencyID, $ClientID, $LocationID, $WarehouseID, $PriceListID, $tipo, $ID, $Title, $importe, $Qty, $Description, $email, $ticket, $PaymentTerm, $AccountID);
// echo $InvoiceID."<hr>";
// echo $AccountID."  Cuenta de banco<hr>";
$resultado = procesa_pago($CurrencyID, $InvoiceID, $AccountID, $importe, $PaymentTerm, $ticket);
// echo $resultado;
