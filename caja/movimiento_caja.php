			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div style="height: 95%"  class="header">
						...
						<hr>
						<h1 style="text-align: center"><b>Movimiento diario</b></h1>
						<hr>
						<div class="row">
							<div class="col-md-12">
	                                    ...
	                                    <div class="panel panel-col-<?php echo $body; ?>">
	                                        ...
	                                        <div id="collapse_<?php echo $id; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading<?php echo $id; ?>">
	                                            <div class="panel-body">
													...
													FROM
														admin
														LEFT JOIN ( SELECT usuario_id, SUM( importe ) AS importe FROM cobros WHERE f_captura = '$fecha' GROUP BY usuario_id ) cobros ON admin.usuario_id = cobros.usuario_id
														...
														LEFT JOIN ( SELECT usuario_id, SUM( importe ) AS importe FROM pagos WHERE f_captura = '$fecha' GROUP BY usuario_id ) pagos ON admin.usuario_id = pagos.usuario_id
