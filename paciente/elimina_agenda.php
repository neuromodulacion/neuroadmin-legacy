...
$delete ="delete from agenda where agenda.agenda_id = $agenda_id";

//echo "<hr>".$delete."<hr>";
 $result_insert = ejecutar($delete);
...
<br>
Se le notifica que su terapia del d&iacute;a $f_ini a las $h_ini fue cancelada <br>
<br>
