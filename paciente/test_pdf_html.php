...
<body style='font-family: Arial, sans-serif;'>
		...
		<table style='width: 100%' >
			<tr style='background: #0096AA; color: #FFF '>
				...
				<th style='text-align: center; padding-top: 10px; padding-bottom: 10px; color: #FFF '>TERAPIA</th>
			...
			$sql_sem2 = "
		    	...
		    	while($row_sem2 = mysqli_fetch_array($result_sem2)){
				   ...
				   $cuerpo_pdf .= "<tr>									   				
				   				...
				   				<td style='text-align: center; width: 10%; background: #EBF5FB;'>$siglas</td>
			...
			<tr>
				<td>
					<table>
						...
						$cuerpo_pdf .=	$tabla."<h4>Se obtuvo $respuesta del $resultado_final% con respecto a la lectura inicial</h4>
						</td>
