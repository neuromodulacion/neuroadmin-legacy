...
extract($_GET);
    ...
    $sql_ubicacion = "
		...
		FROM
			ubicacion_medico 
		WHERE
			ubicacion_medico.usuario_id = $medico_id
		    ";
    //echo $sql_medico."<hr>";
    $result_ubicacion = ejecutar($sql_ubicacion);  // Ejecutar la consulta SQL
    $row_ubicacion = mysqli_fetch_array($result_ubicacion);
    extract($row_ubicacion);
						    ...
						    $('#guardarBtn').on('click', function() {
						        ...
						        $.ajax({
						            ...
						            success: function(html) {
						                alert("Datos guardados con éxito."+html);
						            },
						            error: function() {
						                alert("Error al guardar los datos."+html);
						            }
						        });
						    });
						</script>
