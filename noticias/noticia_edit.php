...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>ALTA</h2>
            <?php //print_r($row);// echo $ubicacion_url."<br>"; 
                ...
                <div class="card">
                    <div style="height: 95%"  class="header">
						...
						<div class="body">
                            ...
                            <input name="insert_multimedia" type="hidden" id="insert_multimedia" value="<?php echo $insert_multimedia; ?>" />	  
                            ...
                            <input style='height: 0px; width: 0px' name="val_obser" type="text" id="val_obser_enc" value="ok" />
							...
							<div <?php echo $displayx; ?> id="video">
								...
								<p><button  class="btn btn-default"  id="actualizarDiv">Insertar</button></p>
							...
							<div  <?php echo $display; ?> id="foto3"> <!--  -->
								<form id="uploadFormz" method="post" enctype="multipart/form-data">
									<div class="row">
									 	 <div class="col-md-6">									    
									    	<div class="thumbnail"><?php echo valida_fotos($imagen_portada); ?><br><?php echo ($imagen_portada); ?>
									      		<img width="300px" id="imagePreviewz" src="<?php echo valida_fotos($imagen_portada); ?>" alt="Tu imagen aparecerá aquí" />
									      		<div class="caption">
										        	<h3>Principal</h3>
										        	<p>Es la foto que va en la cabecera de la noticia</p>
										        	<p><input class="btn btn-primary"  type="file" name="file" id="filez"></p> 
										        	<p><input class="btn btn-default" type="button" value="Subir Foto" id="btnUploadz"></p>
												<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> -->
													<script>
														$(document).ready(function() {
														    $("#btnUploadz").click(function() {
														        var fileInput = $('#filez')[0];
														        var filePath = fileInput.value;
														        var allowedExtensions = /(\.jpg|\.jpeg|\.png|\.gif)$/i;
														        $('#statusz').html("Cargando...");
														        ...
														        var formData = new FormData($("#uploadFormz")[0]);
														        $("#btnUploadz").prop('disabled', true);
														        ...
														        $.ajax({
														            ...
														            success: function(data) {
														                $('#statusz').html("<?php echo $ruta; ?>uploads/"+data);
														                $('#inputRutaImagenz').val("<?php echo $ruta; ?>uploads/"+data);
														
														                var reader = new FileReader();
														                reader.onload = function (e) {
														                    $('#imagePreviewz').attr('src', e.target.result).show();
														                };
														                reader.readAsDataURL($("#filez")[0].files[0]);
														                $("#btnUploadz").prop('disabled', false);
														            },
														            error: function() {
														                $('#statusz').html('Ocurrió un error al subir la foto.');
														            }
														        });
														    });
														});
												...
												<div id="statusz"></div>
													<input type="hidden" id="inputRutaImagenz" name="rutaImagen" value="" >									        
										      	</div>
									    	</div>
									  	</div>	
									</div>
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">                                      
                             	...
                             	<h3>Titulo Corto</h3>
                                <div class="form-line">                                      
									<input type="text" id="titulo_corto" name="titulo_corto" class="form-control" value="<?php echo $titulo_corto; ?>" >
                                </div>  
                             	<h3>Descripción</h3>
                                <div class="form-line">                                      
									<input type="text" id="titulo_corto" name="titulo_corto" class="form-control" value="<?php echo $descripcion; ?>" >
                                </div>	
                             	<h3>Foto Portada</h3>
										...
										<div class="row">
										 	 <div class="col-md-6">									    
										    	<div class="thumbnail">
													...
													?>
										      		<img width="300px" id="imagePreview2" src="<?php echo valida_fotos($imagen_chica); ?>" alt="Tu imagen aparecerá aquí" />
										      		<div class="caption">
											        	<h3>Foto Portada</h3>
											        	<p>Es la foto que va en la cabecera de la noticia</p>
                                ...
                                <div class="media">
                                     <div class="media-object pull-left">
                                          <img id="imagePreview3" width="100px" src="<?php echo valida_fotos($imagen_chica); ?>"  class="thumbnail"  alt="">
                                     </div>	                                     	
                         		</div>
                                <div class="form-line">  	                                        	                                    
									<input type="hidden" id="inputRutaImagen3" name="imagen_chica" class="form-control" value="<?php echo $foto_2; ?>" >
                                </div> 		                                                                                                                                                           
                            </div> 	                               		
                                    <hr>
                                     <div class="form-group form-float">
                                     	<h3>Autor</h3>
                                        <div class="form-line">                                      
     										<input type="text" id="titautorulo" name="autor" class="form-control" value="<?php echo $autor; ?>" >
                                        </div>
                                     	<h3>Titulo Autor</h3>
                                        <div class="form-line">                                      
     										<input type="text" id="titulo_autor" name="titulo_autor" class="form-control" value="<?php echo $titulo_autor; ?>" >
                                        </div>  
                                     	<h3>Foto Autor</h3>
										<!-- para insertar la imagen -->	
										<div id="foto3"> <!--  -->
										<form id="uploadFormy" method="post" enctype="multipart/form-data">
											<div class="row">
											 	 <div class="col-md-6">									    
											    	<div class="thumbnail">
											      		<img width="300px" id="imagePreviewy" src="<?php echo valida_fotos($imagen_autor); ?>" alt="Tu imagen aparecerá aquí" />
											      		<div class="caption">
												        	<h3>Foto Autor</h3>
												        	<p>Es la foto que va en la cabecera de la noticia</p>
														...
														<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> -->
															...
															<div id="statusy"></div>
															<?php
															$test_url = 'https://neuromodulaciongdl.com/images/author-image.jpg';
															$result = valida_fotos($test_url);
															echo $result; // Debería devolver la URL si es válida
															?>

															<input type="text" id="inputRutaImageny" name="rutaImagen" value="<?php echo $imagen_autor; ?>" >
															<input type="text" id="inputRutaImageny" name="rutaImagen" value="<?php echo valida_fotos($imagen_autor); ?>" >									        
													      	</div>
												    	</div>
												  	</div>	
												</div>
	                           		...
	                           		<hr>                                                  	                                     	
                                    <div class="form-line">  	                                        	                                    
 										<input type="text" id="titulo_autor" name="titulo_autor" class="form-control" value="<?php echo valida_fotos($imagen_autor); ?>" >
                                    </div>  	                                        
                                 	<h3>Fecha</h3>
                                    <div class="form-line">                                      
 										<input type="date" id="f_alta" name="f_alta" class="form-control" value="<?php echo $f_alta; ?>" >
                                    </div>  
                                    <hr>                            
