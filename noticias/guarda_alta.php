...
if ($multimedia == '') {
	$multimedia = trim($_POST['multimedia1']);
} 


$insert_multimedia = trim($_POST['insert_multimedia']);
$imagen_chica = trim($_POST['imagen_chica']);
...
if ($insert_multimedia == "Multimedia") {
	...
	$multimedia = "<img  id='multimedia' src='$multimedia1'  />" ;
}	
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand"><i style="color: #0096AA" class="fa fa-user-md"></i> Neuromodulaci&oacute;n Gdl</a>
               </div>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="index.html#about" class="smoothScroll">Acerca de</a></li>
                         ...
                         <li class="appointment-btn"><a style="background: #BBBABA"  href="../inicio.html">Ingresar</a></li>
                    </ul>
               </div>
							    	...
							    	<?php
                                        ...
                                        <div class="media">
                                             <div class="media-object pull-left">
                                                  <a href="news-tms.html"><img src="<?php echo $imagen_chica; ?>" class="img-responsive" alt=""></a>
                                             </div>
                                             <div class="media-body">
                                                  <h4 class="media-heading"><a href=""><?php echo $descripcion; ?></a></h4>
                                             </div>
                                        </div>											
										...
										extract($row_sem2); ?>
			                              <div class="latest-stories">
			                                   ...
			                                   <div class="stories-info">
			                                        <a href="news.php?articulo_id=<?php echo $articulo_idx; ?>"><h5><?php echo $descripcionx; ?></h5></a>
