							    	...
							    	<?php
                                        ...
                                        <div class="media">
                                             ...
                                             <div class="media-body">
                                                  <h4 class="media-heading"><a href="news.php?articulo_id=<?php echo $articulo_idx; ?>"><?php echo $descripcionx; ?></a></h4>
                                             </div>
                                        </div>											
			                              ...
			                              <div class="latest-stories">
			                                   <div class="stories-image">
			                                        <a href="news.php?articulo_id=<?php echo $articulo_idx; ?>">
			                                        	<img src="<?php echo $imagen_chica; ?>" class="img-responsive" alt=""></a>
			                                   </div>
